...
Wird eine Greif- oder Abstellaktion ausgeführt, wird über eine Nachricht an den Actionserver des Knotens '\textit{simple\_gripper}' der Gripper entsprechend geöffnet oder geschlossen.\\(Siehe !!!!-- TODO --!!!! Verweis auf Beschreibung zu unserer simple-Gripper-Node ---!!!)\\
