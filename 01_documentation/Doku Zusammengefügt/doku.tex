...
Mit der Funktion calculate-landing-zone-visualized() wird der Standpunkt, wohin das Objekt platziert werden soll, zurückgegeben. %X=HAUKES FUNKTION
...
pose amount &optional (endFrame "/base\_footprint"), statt.
...
object_amount und object_pose auf den Parameterserver.
