...
\item Mit dem Gewichtssensor soll das verbleibende Gewicht beim Abstellen des Objektes gemessen werden, um besser entscheiden zu können, wann sich das Objekt stehend auf dem Tisch befindet und nicht unnötig Kraft gegen den Tisch einzusetzen.
