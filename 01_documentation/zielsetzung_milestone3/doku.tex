...
Die Zielsetzung des dritten Meilensteins ist es den bisherigen Stand iterativ zu erweitern. Der Zielsetzung des letzten Meilensteins wird daher um folgende Punkte erweitert: \\
...
\item Mit dem Drucksensor soll der Druck beim Abstellen des Objektes gemessen werden, um so besser entscheiden zu können, wann sich das Objekt stehend auf dem Tisch befindet und nicht unnötig Kraft gegen den Tisch einzusetzen.
